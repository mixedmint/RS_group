...
- **Severe Flooding** (rising water)
- **Compounding risk** in vulnerable areas
]

.pull-right[
### Our Response
- Create a **unified dashboard**
- Provide **actionable tools** for decision-makers
- **Shift to proactive prevention**
- Guide investments to most vulnerable spots along the Saigon River
]

**The Rollout Plan:**
1. **City-Wide Screening:** A broad look at the whole city to find the "hotspots."
2. **Priority Pilot:** Focused implementation in the districts that need our help the most.
---

# Global Alignment

## Sendai Framework & SDG 11.5

.pull-left[
### Sendai Framework
- Move from **reconstruction** to **pre-emptive maintenance**
- Use **Earth Observation (EO)** data for real-time decisions
- **Save lives** through proactive planning

<img src="images/SF.webp" style="width: 200px; height: 200px " />
]

.pull-right[
### SDG 11.5
- Reduce human and economic costs of disasters
- Target both floods and sinking land
- Protect livelihoods of at-risk populations

<img src="images/SDG.png" style="width: 150px; height: 150px" />
]
...
| **Approach** | **Efficiency** |
|--------------|-------------------|
| Post-Disaster Recovery | **High Cost** ❌ |
| Pre-emptive Maintenance | **5× Cheaper** ✅ |
| Prevention Investment | **2–10× Returns** ✅ |
]
...
- **EO early warning** cuts impacts by **30–50%**
- **Risk maps** enable local planning
- **Binh Tan district** pilot case study
- Protects livelihoods of vulnerable populations
]
...
.pull-left[
- **Sendai-aligned EO training**
- Reduces reliance on foreign experts
]

.pull-right[
- **InSAR skills** for monitoring
- **Low-cost land tracking**
...
>>>>>>> 170ef84051e5dc46a00818c8469b768c626628fa
---
